...
#' @return Object of \code{\link[R6]{R6Class}} for modelling a WPS DescribeProcess request
#' @format \code{\link[R6]{R6Class}} object.
#' 
#' @note Class used internally by \pkg{ows4R} to trigger a WPS DescribeProcess request
#' 
